...
use crate::{
    error::Result,
    models::{
        Action, AnimationType, InteractionMode, KeyInput, MouseButton, Position, ScrollDirection,
    },
    traits::KeyBindings,
};
...
mod tests {
    ...
    fn test_movement_keys() {
        ...
        // Test up movement
        let action = mode
            .process_input(create_test_input('i'), &bindings)
            .unwrap();
        match action {
        ...
        // Test down movement
        let action = mode
            .process_input(create_test_input('k'), &bindings)
            .unwrap();
        match action {
            Action::MoveCursor(pos, AnimationType::Smooth) => {
                assert_eq!(pos.x, 0);
        ...
        // Test left movement
        let action = mode
            .process_input(create_test_input('j'), &bindings)
            .unwrap();
        match action {
            Action::MoveCursor(pos, AnimationType::Smooth) => {
        ...
        // Test right movement
        let action = mode
            .process_input(create_test_input('l'), &bindings)
            .unwrap();
        match action {
            Action::MoveCursor(pos, AnimationType::Smooth) => {
    ...
    fn test_click_keys() {
        ...
        // Test left click
        let action = mode
            .process_input(create_test_input('n'), &bindings)
            .unwrap();
        assert_eq!(action, Action::Click(MouseButton::Left));

        // Test right click
        let action = mode
            .process_input(create_test_input('m'), &bindings)
            .unwrap();
    ...
    fn test_scroll_keys() {
        ...
        // Test scroll up
        let action = mode
            .process_input(create_test_input('u'), &bindings)
            .unwrap();
        assert_eq!(action, Action::Scroll(ScrollDirection::Up, 3));

        // Test scroll down
        let action = mode
            .process_input(create_test_input('o'), &bindings)
            .unwrap();
        assert_eq!(action, Action::Scroll(ScrollDirection::Down, 3));

        // Test scroll left
        let action = mode
            .process_input(create_test_input('y'), &bindings)
            .unwrap();
        assert_eq!(action, Action::Scroll(ScrollDirection::Left, 3));

        // Test scroll right
        let action = mode
            .process_input(create_test_input('p'), &bindings)
            .unwrap();
    ...
    fn test_hold_toggle() {
        ...
        // Toggle hold state
        let action = mode
            .process_input(create_test_input('b'), &bindings)
            .unwrap();
    ...
    fn test_speed_toggle() {
        ...
        // Toggle speed
        let action = mode
            .process_input(create_test_input('f'), &bindings)
            .unwrap();
    ...
    fn test_screen_switching() {
        ...
        // Test screen 1
        let action = mode
            .process_input(create_test_input('1'), &bindings)
            .unwrap();
        match action {
            Action::MoveCursor(pos, _) => {
        ...
        // Test screen 2
        let action = mode
            .process_input(create_test_input('2'), &bindings)
            .unwrap();
        match action {
            Action::MoveCursor(pos, _) => {
    ...
    fn test_unrecognized_key() {
        ...
        let action = mode
            .process_input(create_test_input('x'), &bindings)
            .unwrap();
        assert_eq!(action, Action::NoAction);
    }
